...
const Transactions = () => {
  return (
    <div className="bg-[#E8F2EE] ">
      ...
      <div className=" bg-[#E8F2EE] py-32 my-24 lg:hidden flex flex-col items-center mx-auto gap-8 ">
        <div className="transactions1 mb-8">
          <h1>Send & receive</h1>
          <h1>money instantly</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
        ...
        <div className="transactions2 lg:hidden grid grid-cols-1 place-content-center">
          <div className="apple">
            <div className="flex gap-2">
              <FontAwesomeIcon
                className="w-4 h-4 p-2 text-xl rounded-full bg-[#5BB5A2] text-[#E8F2FE]"
