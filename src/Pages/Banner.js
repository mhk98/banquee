      ...
      <div className="hidden lg:flex justify-between items-center text-left my-28 px-40 banner">
        <div className="">
          ...
          <div className="flex justify-between pb-4">
            <div>
              <div className="pt-8 flex items-center gap-2">
                <p>
                  <FontAwesomeIcon
                    className="w-4 h-4 p-2 rounded-full bg-[#E8F2FE] text-[#5BB5A2]"
                    icon={faCheck}
                  ></FontAwesomeIcon>
                </p>
          ...
          <div className="py-16 flex items-center gap-8">
            <a class="btn bg-[#5BB5A2] text-white border-none hover:bg-[#E8F2EE] hover:text-[#5BB5A2]">
              Open Account
            </a>
            <p className="text-xl text-[#5BB5A2]">
              Compare Cards{" "}
              <FontAwesomeIcon
                className="pl-2"
                icon={faArrowRight}
